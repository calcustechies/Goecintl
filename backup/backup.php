...
function backup_mysql_database($options){
    ...
    if (($result = fwrite($fp, $contents))) {
		...
		echo "<script>
			...
			</script>"; //alert message with redirection to index page
    }
    fclose($fp);
...
$options = array(
    'db_host'=> 'calcustechnologies.com',  //mysql host
    'db_uname' => 'calcuspro',  //user
    'db_password' => 'CaltecH2016', //pass
    'db_to_backup' => 'currencyxchange', //database name
    'db_backup_path' => '/temp', //where to backup
    'db_exclude_tables' => array('table1','table2') //tables to exclude
);
