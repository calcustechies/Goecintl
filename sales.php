	...
	<div id="page-wrapper" class="gray-bg dashbard-1">
		<div class="content-main">
			...
			<div class="row">
				<div class="col-lg-6 text-center">
					<div class="form-group">
						<label class="control-label col-sm-6" for="email">DATE : &nbsp;&nbsp;&nbsp;<font color="green"><?php echo date("d/m/Y"); ?></font></label>
					</div>
				</div>
				<div class="col-lg-4" style="text-align:center">
					<div class="form-group">
						<label class="control-label col-sm-6" for="email"><p id="bk">Customer Type</p></label>
					</div>
				</div>
				<div class="col-lg-2">
					<div class="form-group">
						<input type="hidden" name="sale_pur" id="sale_pur" value="1">
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="form-group">
						<label class="control-label col-sm-4" for="email">Transaction ID</label>
		 				<div class="col-sm-6">
				...
				<div class="col-lg-6">
					<div class="form-group">
						<label class="control-label col-sm-4" for="email">Customer Code</label>
		 				<div class="col-sm-6">
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" min="1" max="5" id="tel" placeholder="Enter Telephone Number" name="cus_tel" onkeypress="return isNumber(event)" list="phlist" onChange="showUser(this.value)" autocomplete="off" required>
						</div>
					</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-6">
				<div class="form-group">
					<label class="control-label col-sm-4" for="email">Civil No</label>
					<div class="col-sm-3">
						<input type="text" class="form-control" id="civil" placeholder="Enter Civil No" name="cus_civil"  list="cuscivil" onChange="showUser3(this.value)" autocomplete="off"  required>
					</div>
					<div class="col-sm-3">
			...
			<div class="col-lg-6">
				<div class="form-group">
					<label class="control-label col-sm-4" for="email">PP No</label>
					<div class="col-sm-6">
						<input type="text" class="form-control" id="pp" placeholder="Enter PP No" name="cus_pp" list="cuspp" onChange="showUser2(this.value)"  autocomplete="off" required>
					</div>
				</div>
		</div>
	</div>
...
<div class="row">
	<div class="col-lg-6">
		<div class="form-group">
			...
			<div class="col-sm-3">
				<select class="form-control" id="to_c" name="to_c" onChange="calc_rate(this.value,bh_c.value)">
			...
			<div class="col-sm-1">
				<input type="text" class="input-sm" name="stk_v" id="stk_v" size="11" readonly />
			</div>
	...
	<div class="col-lg-6">
		<div class="form-group">
			<label class="control-label col-sm-4" for="email">Commission</label>
			<div class="col-sm-6">
				<input type="number" step="any" class="form-control" id="cmsn" placeholdder="Enter Rounding Amount/Commission" name="cmsn" onChange="cmsn_fun()" value="0.000" required>
			</div>
		</div>
</div>
</div>
...
<div class="row">
	<div class="col-lg-6">
		<div class="form-group">
			<label class="control-label col-sm-4" for="email">Enter Amount</label>
			<div class="col-sm-6">
	...
	<div class="col-lg-6">
		<div class="form-group">
			<label class="control-label col-sm-4" for="email">Equivalent Amount</label>
			<div class="col-sm-6">
...
<div class="row">
	<div class="col-lg-6">
		<div class="form-group">
			<label class="control-label col-sm-4" for="email">Exchange Rate</label>
			<div class="col-sm-6">
				<input type="number" class="form-control" id="rate" onChange="calc_ex_rate_change(to_c.value)" placeholder="" name="rate" step="any" required>
			</div>
		</div>
	</div>
	<div class="col-lg-6">
		<div class="form-group">
			<label class="control-label col-sm-4" for="email">Total Amount</label>
			<div class="col-sm-6">
...
<?php
					...
					if(isset($_POST['sub']))
					{
						...
						//Transaction
						$from_cy="2";  //from currency
						$frm_amt= mysqli_real_escape_string($mysqli,$_POST['frm_amt']); //from Amount
						$to_cy=mysqli_real_escape_string($mysqli,$_POST['to_c']); //to Currency
						...
						$stk_v= mysqli_real_escape_string($mysqli,$_POST['stk_v']); //To Amount
						...
						if( $num_row == '0' )
						{
							...
							if (mysqli_query($mysqli, $sql2)) {
								if($sale_pur == '1')
								{
										echo "<script>window.location='sales.php';window.open('treport2.php?tr_id_n=$newcode55','_blank');</script>";
								}else {
										echo "<script>window.location='sales.php';window.open('treport.php?tr_id_n=$newcode55','_blank');</script>";
								}
...
function calc_rate(str,strr) {
    ...
    if (str == "") {
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
				...
				//rate update
					...
					document.getElementById("rate").value=cy_sale_rate;
					var eq_amt = from_amt*cy_sale_rate;
					...
					var to_amt = parseFloat(eq)+parseFloat(cmsn);
		...
		//var b=document.getElementById("bh_c").value;
        xmlhttp.open("GET","stockdetailsale.php?q="+str+ "&b=" +strr,true);
        xmlhttp.send();
    }
}
    ...
    if (str == "") {
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
				...
				var cmsn=document.getElementById('cmsn').value;
				var stk_v=document.getElementById('stk_v').value;
				
				if(cy_rate != '0')
				{
					var eq_amt = from_amt * cy_rate;
					var to_amt =parseFloat(eq_amt)+parseFloat(cmsn);
					document.getElementById("tot").value=Math.round((to_amt)*1000)/1000;
					document.getElementById("to_amt").value=Math.round((eq_amt)*1000)/1000;
					document.getElementById("r").value="0";

					if (parseFloat(from_amt) > parseFloat(stk_v)) {
						document.getElementById("sub").disabled = true;
						document.getElementById("sub").style.color = "#ff0000";
						alert("FC Amount is Greater Than Currency Stock");
					}else
					{
        ...
        xmlhttp.open("GET","ratedetailsale.php?q="+str,true);
        xmlhttp.send();
    }
}
    ...
    if (str == "") {
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
				...
				var toc=document.getElementById('to_c').value;
				var from_amt=document.getElementById('from_amt').value;
				var cy_rate=document.getElementById('rate').value;
				var cmsn=document.getElementById('cmsn').value;
				...
				var cy_sale_rate = a['cy_sale_rate'];
						 ...
						 if(to_cy2 == toc){
								...
								{
										alert("Sales Rate Less than exchange rate");
										document.getElementById("rate").value=cy_rate;
										var eq_amt2=from_amt*cy_rate;
										var to_amt2 = parseFloat(eq_amt2)+parseFloat(cmsn);
    ...
    if (str == "") {
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
				...
				var total = parseFloat(to_amt)+parseFloat(cmsn);
    ...
    if (str == "") {
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
				...
				var total_v= parseFloat(to_amt)+parseFloat(cmsn);
    ...
    if (str == "") {
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
				...
				var round1=parseFloat(to_amt)+parseFloat(cmsn);
