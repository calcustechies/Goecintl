<?php
	...
	if(isset($_GET['tr_id_n']))
	{
		$tr_id_n = $_GET['tr_id_n'];
	}
	$getDet=mysqli_query($mysqli,"SELECT * FROM branch WHERE `bh_code`='$bh_id';");
	$sql1=mysqli_query($mysqli,"SELECT * FROM transaction,customer WHERE `cus_code` = `cus_id` AND transaction.bh_code='$bh_id' AND transaction.tr_id='$tr_id_n'");

	$getDet1=mysqli_query($mysqli,"SELECT * FROM branch WHERE `bh_code`='$bh_id';");
	$sql11=mysqli_query($mysqli,"SELECT * FROM transaction,customer WHERE `cus_code` = `cus_id` AND transaction.bh_code='$bh_id' AND transaction.tr_id='$tr_id_n'");
...
$pdf->Ln();$pdf->Ln();
	...
	if($getDet)
	{
			...
			if (strpos($rows['frm_amt'], ".") != false) {
				...
				//----------------------------------------------------
			//$pdf->Cell(30,4,$rows['frm_amt'],0,0,'R');
			$pdf->Ln();
			...
			//$pdf->Cell(30,4,$rows['equvallent'],0,0,'R');
			$pdf->Ln();
			...
			//$pdf->Cell(30,4,$rows['round'],0,0,'R');
			$pdf->Ln();
